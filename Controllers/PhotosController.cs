...
namespace PhotoArchive.Controllers
{
    public class PhotosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("id,Name,Pic,Date,Is_Liked,Page,Line,Place_In_Line,Format")] Photo photo)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("id,Name,Pic,Date,Is_Liked,Page,Line,Place_In_Line,Format")] Photo photo)
        {
            if (id != photo.id)
            {
                return NotFound();
